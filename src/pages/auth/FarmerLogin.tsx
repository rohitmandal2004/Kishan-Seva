...
export default function FarmerLogin() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-emerald-50/40 flex flex-col justify-center items-center p-6">
      ...
      <div className="flex flex-col sm:flex-row items-center gap-3.5 mb-6 text-center sm:text-left">
        <div className="p-2.5 rounded-3xl bg-white border-2 border-emerald-100 shadow-md hover:scale-105 transition-transform">
          <img 
            src="/logo.svg" 
        ...
        <div>
          <h1 className="text-3xl font-black text-[#143d23] leading-none">
      ...
      <Card className="w-full max-w-md p-8 shadow-xl border border-slate-200/80 rounded-3xl bg-white relative">
        ...
        <div className="mb-6 p-3.5 bg-emerald-50/90 border border-emerald-200 rounded-2xl flex items-center justify-between gap-3 shadow-xs">
          <div>
